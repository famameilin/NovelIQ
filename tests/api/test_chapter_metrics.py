...
def _insert_three_chapter_run(db_session, *, annotated: bool = True) -> tuple[str, str]:
    ...
    spans = [
        make_span(
            paragraph_id=0, chunk_id=0, chapter_id=1, paragraph_index=0,
            text="他怒喝一声！", local_start=0, chunk_offset=0, token_count=5,
        ),
        make_span(
            paragraph_id=1, chunk_id=0, chapter_id=1, paragraph_index=1,
            text="你为何如此？", local_start=6, chunk_offset=0, token_count=5,
        ),
        make_span(
            paragraph_id=2, chunk_id=1, chapter_id=2, paragraph_index=0,
            text="平静地叙述日常。", local_start=0, chunk_offset=13, token_count=7,
        ),
        make_span(
            paragraph_id=3, chunk_id=2, chapter_id=3, paragraph_index=0,

...
def test_ensure_chunk_embeddings_schema_creates_table_in_runtime_schema(db_session) -> None:
    ...
    ensure_chunk_embeddings_schema(db_session, settings.models.paragraph_embedding.embedding_dim)
    validate_chunk_embeddings_schema(db_session, settings.models.paragraph_embedding.embedding_dim)

...
// 新建原因：把图谱配色提取成独立模块，避免 ForceGraph 同时维护生命周期和颜色映射。
...
// 2026-04-23，任务：复杂度与耦合审查 P1
// 新建原因：统一关系类型颜色来源，保证图例和图谱主图后续可以复用同一套调色规则。
...
// 2026-04-23，任务：复杂度与耦合审查 P1
// 新建原因：收口辅助色，避免 ForceGraph 在多个闭包里重复读取 CSS 变量。
...
// 2026-04-23，任务：复杂度与耦合审查 P1
// 新建原因：给 G6 生命周期 hook 提供单一 palette 输入，减少跨文件参数噪声。

...
class DisambiguationState:
    ...
    def with_updates(
        ...
        return DisambiguationState(
            ...
            known_canonical_names=known_canonical_names if known_canonical_names is not None else self.known_canonical_names,
    ...
    def from_dict(cls, data: dict) -> DisambiguationState:
        ...
        return cls(
            ...
            alias_merges=frozenset(
                tuple(item) for item in data.get("alias_merges", [])
